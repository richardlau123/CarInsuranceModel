...
//update to a new vin
app.put('/vehicle/update/:oldvin/:newvin', (req, res) => {

    let queryString = 'update Vehicle set vin = ';
    queryString+="'"+req.params['newvin']+"' where vin =";
    queryString+="'"+req.params['oldvin']+"'";
